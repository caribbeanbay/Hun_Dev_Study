# 스포일러 방지 (Programmers - Level 1)

**출처:** 프로그래머스 | **링크:** [문제 링크](https://school.programmers.co.kr/learn/courses/30/lessons/468370)
...
![스포 방지 처리된 채팅](images/img1_spoiler_ex1.png)

스포 방지 처리된 채팅입니다.

![첫 번째 스포 방지 해제](images/img2_ex1_reveal1.png)

첫 번째 스포 방지를 해제한 채팅입니다. 첫 번째 스포 방지 구간을 해제하면 단어 here이 공개됩니다. here은 스포 방지 구간이 아닌 영역에서 등장한 적 있습니다. 따라서 중요한 단어가 아닙니다.

![두 번째 스포 방지 해제](images/img3_ex1_reveal2.png)
...
![스포 방지 처리된 채팅](images/img4_spoiler_ex2.png)

스포 방지 처리된 채팅입니다.

![첫 번째 스포 방지 해제](images/img5_ex2_reveal1.png)
